            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="calculation" className="border-border">
                ...
                <AccordionContent className="text-base text-muted-foreground space-y-4">
                  <p>
                    Rankings are derived directly from on-chain data. Your score equals the total
                    {TOKEN_SYMBOL} volume you have contributed across all prediction pools — the more you
                    participate, the higher you rank.
                  </p>
                  <ul className="list-disc pl-6 space-y-2 mt-2">
                    <li>Total {TOKEN_SYMBOL} wagered across all pools you have bet in</li>
                    <li>Volume generated by pools you have created</li>
                    <li>Rankings update in real time as new on-chain activity is confirmed</li>
                  </ul>
                </AccordionContent>
              </AccordionItem>
            </Accordion>
